...
export default function Games() {
  ...
  return (
    <Screen scroll>
      ...
      <FeatureTile emoji="🃏" title="Challenge Cards" subtitle="Cute · Romantic · Spicy · Wild" badge="Free" />
      <FeatureTile emoji="🎡" title="Couple Wheel" subtitle="Spin for a reward" badge="Free" />
